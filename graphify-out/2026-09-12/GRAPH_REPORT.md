...
## Corpus Check
- 77 files · ~33,269 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 643 nodes · 873 edges · 51 communities (39 shown, 12 thin omitted)
...
1. `TextInterpreter` - 14 edges
2. `normalizarLandmarksMano()` - 14 edges
3. `ejecutarFotograma()` - 13 edges
