# Graph Report - AulaSenas2  (2026-09-22)

## Corpus Check
- 103 files · ~22,876,496 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1010 nodes · 1471 edges · 69 communities (54 shown, 15 thin omitted)
...
### Community 1 - "dataset-server.test.js"
Cohesion: 0.21
Nodes (10): assertCatalog(), bootstrapDataset(), initializeDataset(), isRecord(), appRoot, contractsRoot, hand(), projectRoot (+2 more)
...
Cohesion: 0.33
Nodes (6): handVector(), invalid(), isPoint(), LITE_FEATURES, LiteVectorizer139, normalize()

### Community 12 - "liteVectorizer139.test.js"
Cohesion: 0.70
Nodes (4): extraction(), hand(), point(), raw()
...
Cohesion: 0.14
Nodes (9): camera, extractor, fifo, metrics, overlay, ui, vectorizer, video (+1 more)
...
### Community 114 - "ContractValidator.js"
Cohesion: 0.27
...
## Knowledge Gaps
- **355 isolated node(s):** `name`, `private`, `version`, `type`, `check` (+350 more)
...
- **Why does `validateSample()` connect `lite-pipeline.test.js` to `DatasetService.js`?**
