# Graph Report - AulaSenas2  (2026-09-17)

## Corpus Check
- 93 files · ~47,445 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1281 nodes · 1706 edges · 105 communities (83 shown, 22 thin omitted)
...
1. `ConfiguratorUI` - 28 edges
2. `ClassCatalog` - 14 edges
3. `normalizarLandmarksMano()` - 14 edges
4. `ejecutarFotograma()` - 13 edges
5. `TextInterpreter` - 13 edges
6. `$defs` - 13 edges
7. `ValidatedDatasetStore` - 12 edges
8. `VideoControls` - 12 edges
9. `UserInterface` - 12 edges
10. `onResults()` - 12 edges
...
Cohesion: 0.14
Nodes (9): UserPreferences, diagnosticoArranque, landmarkRenderer, preferences, removeLandmarkListener, speech, translator, ui (+1 more)
...
Cohesion: 0.17
Nodes (11): classCatalog, contracts, datasetStore, extractor, pendingCapture, sampleCounts, source, ui (+3 more)
...
Cohesion: 0.15
Nodes (13): description, $ref, $ref, minLength, type, $ref, properties, classId (+5 more)

### Community 32 - "sample-metadata.schema.json"
Cohesion: 0.11
Nodes (17): additionalProperties, description, $id, description, type, type, type, properties (+9 more)
...
Cohesion: 0.09
Nodes (24): observacionManos, additionalProperties, allOf, properties, type, additionalProperties, allOf, properties (+16 more)
...
Cohesion: 0.13
Nodes (21): properties, additionalProperties, properties, type, componenteObservadoRostro, items, type, $ref (+13 more)
...
### Community 61 - "ClassCatalog"
Cohesion: 0.21
Nodes (4): ClassCatalog, compact(), parseClassList(), structuredCloneSafe()
...
### Community 65 - "$defs"
Cohesion: 0.13
Nodes (15): additionalProperties, type, $defs, componenteObservadoPose, landmarksPose, representacionNormalizada, description, items (+7 more)

### Community 66 - "ValidatedDatasetStore"
Cohesion: 0.32
Nodes (4): readJson(), readOptionalJson(), ValidatedDatasetStore, writeJson()

### Community 67 - "LocalLandmarkExtractor.js"
Cohesion: 0.11
Nodes (25): capture, segmentProcessor, absentHand(), absentSlots(), buildComponent(), buildHand(), buildHands(), buildNormalized() (+17 more)
...
### Community 71 - "estado"
Cohesion: 0.22
Nodes (14): required, required, required, estado, required, required, required, diagnosticos (+6 more)
...
Cohesion: 0.06
Nodes (35): properties, description, minLength, type, description, type, description, enum (+27 more)

### Community 74 - "sign-class.schema.json"
Cohesion: 0.07
Nodes (26): additionalProperties, required, type, x-aulasenas-invariants, allOf, allOf, $comment, $defs (+18 more)

### Community 75 - "class-meaning.schema.json"
Cohesion: 0.09
Nodes (22): additionalProperties, description, description, type, $id, description, minLength, type (+14 more)
...
Cohesion: 0.29
Nodes (7): classId, required, capturedAt, frames, fuente, metadata, tiempo
...
Cohesion: 0.19
Nodes (5): CaptureSession, createSampleLabel(), SampleWorkflow, validateSample(), validClassContract

### Community 88 - "rostro"
Cohesion: 0.20
Nodes (10): observacionVisual, additionalProperties, description, properties, type, rostro, additionalProperties, $ref (+2 more)

### Community 89 - "landmarksRostro"
Cohesion: 0.29
...
### Community 101 - "updatedAt"
Cohesion: 0.50
Nodes (4): updatedAt, description, format, type

### Community 102 - "capturedAt"
Cohesion: 0.50
Nodes (4): description, format, type, capturedAt

## Knowledge Gaps
- **570 isolated node(s):** `name`, `private`, `version`, `type`, `check` (+565 more)
...
- **Why does `$defs` connect `$defs` to `landmarksMano`, `landmarksRostro`, `enum`, `derecha`, `visual-frame.schema.json`, `rostro`, `diagnosticos`, `slotLandmark`, `properties`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `observacionVisual` connect `rostro` to `$defs`, `enum`?**
