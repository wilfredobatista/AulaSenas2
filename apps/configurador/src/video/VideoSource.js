...
export class VideoSource {
   ...
   */
  async startCamera(constraints = { video: { width: { ideal: 640 }, height: { ideal: 480 }, frameRate: { ideal: 30 } }, audio: false }) {
  ...
  loadFile(file) {
    ...
    // Los controles propios conservan marcadores y navegación precisa; no se
    // muestra una segunda línea temporal nativa que sugiera otro flujo.
    this.video.controls = false; this.video.load(); return this.video;
  }
