# Graph Report - AulaSenas2  (2026-09-14)

## Corpus Check
- 79 files · ~34,122 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 654 nodes · 889 edges · 53 communities (40 shown, 13 thin omitted)
...
Cohesion: 0.06
Nodes (24): UserPreferences, camera, diagnosticoArranque, interpreter, landmarkRenderer, preferences, removeLandmarkListener, removePresenceListener (+16 more)
...
Cohesion: 0.38
Nodes (9): Add-CorsHeaders(), Get-GeminiText(), Get-RequestText(), Get-UpstreamErrorBody(), Get-UpstreamStatus(), Handle-Request(), Invoke-Gemini(), Write-GeminiFailure() (+1 more)

## Knowledge Gaps
- **228 isolated node(s):** `name`, `private`, `version`, `type`, `check` (+223 more)
...
- **Why does `SpeechService` connect `SpeechService` to `usuario/src/main.js`?**
